...
SC_MODULE(router){
    ...
    void connections(){
        ...
        rok_ww_e_o[3] = l_rok_w.read()[0];
        rok_ww_e_o[2] = n_rok_w.read()[0];
        rok_ww_e_o[1] = s_rok_w.read()[0];
        rok_ww_e_o[0] = w_rok_w.read()[0];
        rok_w_e_o.write(rok_ww_e_o);

        req_ww_e_o[3] = l_req_e_xout_w.read()[0];
        req_ww_e_o[2] = n_req_e_xout_w.read()[0];
        req_ww_e_o[1] = s_req_e_xout_w.read()[0];
        req_ww_e_o[0] = w_req_e_xout_w.read()[0];
